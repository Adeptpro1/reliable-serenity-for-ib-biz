...
// Create Notice removed as it is defined in notice.js
...
export const PURCHASE_TOP_LISTING = gql`
  mutation PurchaseTopListing($input: PurchaseTopListingInput!) {
    purchaseTopListing(input: $input) {
      id
      businessId
      toplistad
      startDate
