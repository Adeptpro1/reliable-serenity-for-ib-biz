      ...
      >
        ...
        {/* Contact Section */}
          <div
            ...
            onClick={() =>
                window.open(
                  "mailto:isalesng@gmail.com?subject=Send us Mail&body=",
                  "_blank"
                )
              }
            >
          ...
          <div className="mt-12 mb-4 w-full flex justify-center">
            <p className="text-sm font-medium text-gray-500">
              Debisi is a proud product of <a href="mailto:isalesng@gmail.com" className="text-blue-500 hover:text-blue-600 transition-colors">iSalesNG Emporium</a>.
            </p>
          </div>
        </div>
      <ScrollFooterWrapper />
