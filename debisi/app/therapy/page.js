...
import { REQUEST_THERAPY_SESSION } from "@/graphql/queries/therapy";
      ...
      <main className="flex-1 flex flex-col items-center justify-center" style={{ padding: "60px 20px" }}>
        <div className="w-full max-w-2xl bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden" style={{ margin: "0 auto", padding: "40px" }}>
          ...
          <div className="text-center" style={{ marginBottom: "30px" }}>
            ...
            <h1 className="text-3xl font-bold text-gray-900" style={{ marginBottom: "10px" }}>Request a Business Therapy Session</h1>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col">
            ...
            >
              {loading ? "Submitting..." : "Send Request (Coming soon)"}
            </button>
          </form>
        </div>
      </main>
