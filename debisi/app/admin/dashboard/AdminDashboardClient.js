...
import {
  ...
  FaCalendar, FaNewspaper, FaSignOutAlt, FaStar, FaShoppingBag
} from "react-icons/fa";
...
const AuditLogsForAdmin    = lazy(() => import("@/components/adminComponents/AuditLogsForAdmin"));
const VerificationForAdmin = lazy(() => import("@/components/adminComponents/VerificationForAdmin"));
const ReachOutForAdmin     = lazy(() => import("@/components/adminComponents/ReachOutForAdmin"));
const BotwForAdmin        = lazy(() => import("@/components/adminComponents/BotwForAdmin"));
const ProductsForAdmin    = lazy(() => import("@/components/adminComponents/ProductsForAdmin"));
const TopListingsForAdmin = lazy(() => import("@/components/adminComponents/TopListingsForAdmin"));
const VideoCostsForAdmin  = lazy(() => import("@/components/adminComponents/VideoCostsForAdmin"));
...
const menuGroups = [
  { group: "Main", items: [{ id: "overview", label: "Overview", icon: <FaHammer /> }] },
  {
    ...
    items: [
      ...
      { id: "verifications", label: "Verifications", icon: <FaClipboardList /> },
      { id: "auditLogs", label: "Audit Logs", icon: <FaClipboardList /> },
    ],
  },
  {
    group: "Content & Community",
    items: [
      { id: "products", label: "Products & Flags", icon: <FaShoppingBag /> },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "videoCosts", label: "CDN Video Margins", icon: <FaVideo /> },
  ...
  },
  {
    group: "Marketing",
    items: [
      { id: "topListings", label: "Top Listings", icon: <FaStar /> },
...
const AdminPageContent = ({ userData }) => {
  ...
  const renderComponent = () => {
    switch (activeComponent) {
      ...
      case "verifications":  return <VerificationForAdmin />;
      case "auditLogs":      return <AuditLogsForAdmin />;
      ...
      case "reachOut":       return <ReachOutForAdmin />;
      ...
      case "topListings":    return <TopListingsForAdmin />;
      case "videoCosts":     return <VideoCostsForAdmin />;
      default:
        return (
              ...
              <ul className="space-y-0.5">
                {group.items.map(({ id, label, icon }) => (
                  <li key={id}>
                    <button
                      className={[
                        "flex items-center w-full gap-3 px-3 py-3 min-h-11 rounded-xl",
...
export default withAuth(AdminPageContent);
