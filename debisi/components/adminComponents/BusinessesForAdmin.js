    ...
    <div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 flex items-center hover:shadow-md transition-shadow" style={{ padding: '24px', gap: '16px' }}>
          ...
          <div>
            ...
            <h2 className="text-3xl font-bold text-gray-900">
              {(data?.adminBusinessesCount ?? flatBusinesses.length).toLocaleString()}
            </h2>
          </div>
        </div>
      </div>
      ...
      <div className="animate-in fade-in slide-in-from-bottom-2 duration-700">
        <div className="mb-6">
          <AdminSearch 
            data={flatBusinesses} 
            placeholder="Search businesses by name, category, or slug across all records..."
        ...
        <Modal title="Edit Business" onClose={() => setEditingBusiness(null)}>
          <form onSubmit={handleUpdate} className="flex flex-col" style={{ gap: '16px' }}>
            ...
            <div>
              ...
              >
                {[
                  "AGRIBUSINESS", "AGRICULTURE", "AUTOMOTIVE", "BEAUTY_PERSONAL_CARE", "CONSTRUCTION",
                  "CREATIVE_ENTERTAINMENT", "EDUCATION", "ENERGY", "ENERGY_UTILITIES",
                  "ENTERTAINMENT_EVENTS", "ENVIRONMENTAL_SERVICES", "FASHION_APPAREL",
                  "FINANCIAL_SERVICES", "FOOD_BEVERAGES", "GOVERNMENT_PUBLIC_SERVICES", "HEALTHCARE",
                  "HOME_LIVING", "HOSPITALITY_TOURISM", "HOUSEHOLD_SERVICES", "INDUSTRIAL_MANUFACTURING",
                  "INFORMATION_TECHNOLOGY", "LEGAL_SERVICES", "LOGISTICS_TRANSPORTATION",
                  "MANUFACTURING", "MARKETING_ADVERTISING", "MEDIA_COMMUNICATIONS", "MEDIA_PUBLISHING",
                  "MINING", "NONPROFIT_COMMUNITY", "PERSONAL_SERVICES", "PET_ANIMAL_SERVICES",
                  "PROFESSIONAL_SERVICES", "REAL_ESTATE", "RELIGIOUS_ORGANIZATIONS",
                  "REPAIR_MAINTENANCE", "RETAIL_ECOMMERCE", "RETAIL_WHOLESALE", "SAFETY_SECURITY",
                  "SECURITY_SERVICES", "SPORTS_FITNESS", "TECHNOLOGY", "TELECOMMUNICATIONS",
                  "TOURISM_HOSPITALITY", "TRADES_ARTISANS", "TRANSPORT_LOGISTICS",
                  "WHOLESALE_DISTRIBUTION", "OTHER"
                ].map(cat => (
