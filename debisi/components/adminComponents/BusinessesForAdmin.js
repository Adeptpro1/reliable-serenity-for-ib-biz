...
import { GET_ADMIN_BUSINESSES } from "../../api/queries/admin/businesses";
import { ADMIN_DELETE_BUSINESS, ADMIN_UPDATE_BUSINESS } from "../../api/mutations/admin/businesses";
          ...
          <form onSubmit={handleUpdate} className="flex flex-col" style={{ gap: '16px' }}>
            ...
            <div>
              ...
              >
                ...
                <option value="RETAIL_WHOLESALE">RETAIL_WHOLESALE</option>
                <option value="TECHNOLOGY">TECHNOLOGY</option>
                <option value="HEALTHCARE">HEALTHCARE</option>
                <option value="EDUCATION">EDUCATION</option>
                <option value="TOURISM_HOSPITALITY">TOURISM_HOSPITALITY</option>
                <option value="REAL_ESTATE">REAL_ESTATE</option>
                <option value="TRANSPORT_LOGISTICS">TRANSPORT_LOGISTICS</option>
                <option value="FINANCIAL_SERVICES">FINANCIAL_SERVICES</option>
                <option value="ENERGY">ENERGY</option>
                <option value="MINING">MINING</option>
                <option value="CREATIVE_ENTERTAINMENT">CREATIVE_ENTERTAINMENT</option>
                <option value="PROFESSIONAL_SERVICES">PROFESSIONAL_SERVICES</option>
                <option value="ENVIRONMENTAL_SERVICES">ENVIRONMENTAL_SERVICES</option>
                <option value="SECURITY_SERVICES">SECURITY_SERVICES</option>
                <option value="TELECOMMUNICATIONS">TELECOMMUNICATIONS</option>
                <option value="MEDIA_PUBLISHING">MEDIA_PUBLISHING</option>
                <option value="AUTOMOTIVE">AUTOMOTIVE</option>
                <option value="PERSONAL_SERVICES">PERSONAL_SERVICES</option>
                <option value="HOUSEHOLD_SERVICES">HOUSEHOLD_SERVICES</option>
              </select>
            </div>
