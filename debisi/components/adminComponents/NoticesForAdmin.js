...
import { GET_ADMIN_NOTICES, DELETE_NOTICE } from "@/api/queries/business/notice";
import { EXPORT_LEADS_CSV } from "@/api/queries/report";
...
import { ADMIN_DELETE_NOTICE, ADMIN_UPDATE_NOTICE } from "../../api/mutations/admin/notices";
        ...
        <div className="flex gap-2">
          ...
          >
           ...
           <button 
            onClick={(e) => {
              e.stopPropagation();
              if (row.link) window.open(row.link, "_blank");
              else toast.error("No link provided");
            }}
