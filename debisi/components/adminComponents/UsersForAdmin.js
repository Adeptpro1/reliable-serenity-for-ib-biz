...
const UsersForAdmin = () => {
  ...
  // Fetch users from GraphQL with server-side search & pagination
    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2" style={{ gap: '24px', marginBottom: '24px' }}>
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 flex items-center hover:shadow-md transition-shadow" style={{ padding: '24px', gap: '16px' }}>
          ...
          <div>
            ...
            <h2 className="text-3xl font-bold text-gray-900">
              {(data?.adminUsersCount ?? users.length).toLocaleString()}
            </h2>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 flex items-center hover:shadow-md transition-shadow" style={{ padding: '24px', gap: '16px' }}>
          ...
          <div>
            <p className="text-sm font-medium text-gray-500 uppercase tracking-wider">With Business (Page)</p>
            <h2 className="text-3xl font-bold text-gray-900">
      ...
      <div className="animate-in fade-in slide-in-from-bottom-2 duration-700">
        <div className="mb-6">
          <AdminSearch 
            data={flatUsers} 
            placeholder="Search users by name, email across all records..."
