...
const BotwManager = ({ userData }) => {
  ...
  const botwFee = dbPricings.find((p) => p.category === "BANNER_ADS" && (p.title.includes("BOTW") || p.title.includes("Week")))?.amount ?? 25000;
                  ...
                  {!verifiedBusiness ? (
                    ...
                    <div>
                      ...
                      <p style={{ color: "#64748b", fontSize: "13px", margin: "0 0 20px" }}>
                        Applying as <strong>{verifiedBusiness.name}</strong>. A one-time fee of <strong>₦{botwFee.toLocaleString()}</strong> will be charged via Paystack.
                      ...
                      <div style={{ display: "flex", alignItems: "center", gap: "16px", flexWrap: "wrap" }}>
                        ...
                        >
                          <FaRocket /> {applying ? "Opening Paystack..." : `Apply — ₦${botwFee.toLocaleString()}`}
                        </button>
              ...
              <div style={{ background: "#f8fafc", border: "1px solid #e2e8f0", borderRadius: "14px", padding: "20px 24px" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
                  {[
                    ...
                    ["💳 Pay", `Pay ₦${botwFee.toLocaleString()} securely via Paystack (no wallet deducted)`],
