      ...
      <form onSubmit={handleSubmit(onSubmit, onInvalidSubmit)} className="space-y-6">
        ...
        <div className="form-group">
          ...
          <input
            type="text"
            style={{ padding: "10px" }}
            className={`w-full border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 ${errors.businessName ? "border-red-500" : "border-gray-300"
              }`}
        ...
        <div className="form-group">
          ...
          <textarea
            style={{ padding: "10px" }}
            className={`w-full border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 ${errors.primaryAddress ? "border-red-500" : "border-gray-300"
              }`}
            rows="3"
        ...
        <div className="form-group">
          ...
          <select
            style={{ padding: "10px" }}
            className={`w-full border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 ${errors.category ? "border-red-500" : "border-gray-300"
              }`}
        ...
        <div className="form-group">
          ...
          <textarea
            style={{ padding: "10px" }}
            className={`w-full border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 ${errors.description ? "border-red-500" : "border-gray-300"
              }`}
            rows="5"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="form-group">
            ...
            <select
              style={{ padding: "10px" }}
              className={`w-full border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 ${errors.town ? "border-red-500" : "border-gray-300"
                }`}
          ...
          <div className="form-group">
            ...
            <select
              style={{ padding: "10px" }}
              className={`w-full border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 ${errors.city ? "border-red-500" : "border-gray-300"
                }`}
        ...
        <div className="form-group">
          ...
          <input
            type="tel"
            style={{ padding: "10px" }}
            className={`w-full border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 ${errors.phone ? "border-red-500" : "border-gray-300"
              }`}
            {...register("phone", {
